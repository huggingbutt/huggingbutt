"""
This file is copied from the unity_gym_env.py of the mlagents project,
and some modifications are made so that it can run on the latest version of gymnasium(gym)
"""
import itertools
import numpy as np
...
class UnityToGymWrapper(gym.Env):
    ...
    def __init__(
        ...
        :param unity_env:
        :param uint8_visual:
        :param flatten_branched:
        :param allow_multiple_obs:
        :param action_space_seed:
        """
        self._env = unity_env
